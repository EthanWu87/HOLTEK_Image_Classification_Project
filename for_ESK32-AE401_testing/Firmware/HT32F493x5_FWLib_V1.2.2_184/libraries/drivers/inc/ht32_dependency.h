...
#define MIN_HT32_FWLIB_VER              (0x01001004) //0xmmnnnrrr -> Vm.n.r
#define MIN_HT32_FWLIB_SVN              (0x53)
#endif
#if defined(__HT32F491x3_H)
#define MIN_HT32_FWLIB_VER              (0x01000006) //0xmmnnnrrr -> Vm.n.r
#define MIN_HT32_FWLIB_SVN              (0x131)
#endif
...
// Check "ht32f493x5.h" for the version of HT32 Firmwar Library
