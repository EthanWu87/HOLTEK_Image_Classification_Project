 ...
 * @version V1.1
 * @date    2025-08-19
 * @brief   ble gls app configuration.
 *************************************************************************************************************
 * @attention
 *
...
#define FLASH_MP_APP_CODE_SIZE_MAX          (80 * KBYTE)
...
#define BLE_ADV_NAME_STRING                 ("HT32F675x5_GLS_APP2")
#define BLE_DEVICE_MAC                      {0x55, 0x71, 0x4D, 0x03, 0x3B, 0xCC}
...
// GLS Device
//=====================================================================================================================
#define GLS_DB_RECORDS_MAX_NUM             (100)
// UART
#define GLS_UART_HANDLE                     (UART1)
#define GLS_UART_PORT_TX                    (GPIO_PORT_UART1_TX)
#define GLS_UART_PIN_TX                     (GPIO_PIN_UART1_TX)
#define GLS_UART_PORT_RX                    (GPIO_PORT_UART1_RX)
#define GLS_UART_PIN_RX                     (GPIO_PIN_UART1_RX)
#define GLS_UART_BPS                        (460800)
#define GLS_UART_BUF_SIZE                   (512)
#endif /* __APP_CFG_H__ */
