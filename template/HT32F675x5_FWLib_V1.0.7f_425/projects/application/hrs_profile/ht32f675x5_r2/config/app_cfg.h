 ...
 * @version V1.1
 * @date    2025-08-19
 * @brief   ble hrs app configuration.
 *************************************************************************************************************
 * @attention
 *
...
#define FLASH_MP_APP_CODE_SIZE_MAX          (60 * KBYTE)
...
#define BLE_ADV_NAME_STRING                 ("HT32F675x5_HRS_APP_2")
#define BLE_DEVICE_MAC                      {0x59, 0x80, 0x7D, 0x03, 0xBB, 0xCC}
...
// HRS Device
//=====================================================================================================================
#define HRS_DB_RECORDS_MAX_NUM             (100)
// UART
#define HRS_UART_HANDLE                     (UART1)
#define HRS_UART_PORT_TX                    (GPIO_PORT_UART1_TX)
#define HRS_UART_PIN_TX                     (GPIO_PIN_UART1_TX)
#define HRS_UART_PORT_RX                    (GPIO_PORT_UART1_RX)
#define HRS_UART_PIN_RX                     (GPIO_PIN_UART1_RX)
#define HRS_UART_BPS                        (460800)
#define HRS_UART_BUF_SIZE                   (512)
#endif /* __APP_CFG_H__ */
