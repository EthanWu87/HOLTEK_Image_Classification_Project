 ...
 * @version V1.1
 * @date    2025-08-19
 * @brief   ble cgm app configuration.
 *************************************************************************************************************
 * @attention
 *
...
#define RAM_CP_SIZE_MAX                     (124 * KBYTE)
...
#define FLASH_MP_APP_CODE_SIZE_MAX          (200 * KBYTE)
...
#define BLE_ADV_NAME_STRING                 ("Holtek_CGMS_App1")
