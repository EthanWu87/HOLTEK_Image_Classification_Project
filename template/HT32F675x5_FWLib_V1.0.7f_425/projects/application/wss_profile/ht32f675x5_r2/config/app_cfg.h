 ...
 * @version V1.1
 * @date    2025-08-19
 * @brief   ble wss app configuration.
 *************************************************************************************************************
 * @attention
 *
...
#define FLASH_MP_APP_CODE_SIZE_MAX          (64 * KBYTE)
...
#define BLE_ADV_NAME_STRING                 ("HT32F675x5_WSS_APP_1")
#define BLE_DEVICE_MAC                      {0x55, 0x41, 0x4D, 0x13, 0xBB, 0xCC}

//=====================================================================================================================
// APP Version
//=====================================================================================================================
#define APP_VERSION                         (0x0001) // V0.2
...
// WSS Device
//=====================================================================================================================
#define WSS_DB_RECORDS_MAX_NUM             (100)
// UART
#define WSS_UART_HANDLE                     (UART1)
#define WSS_UART_PORT_TX                    (GPIO_PORT_UART1_TX)
#define WSS_UART_PIN_TX                     (GPIO_PIN_UART1_TX)
#define WSS_UART_PORT_RX                    (GPIO_PORT_UART1_RX)
#define WSS_UART_PIN_RX                     (GPIO_PIN_UART1_RX)
#define WSS_UART_BPS                        (460800)
#define WSS_UART_BUF_SIZE                   (512)
#endif /* __APP_CFG_H__ */
