 ...
 * @version V1.1
 * @date    2025-08-20
 * @brief   BLE Low Power Evaluation app configuration.
 *************************************************************************************************************
 * @attention
 *
...
// BLE
//=============================================================================
#define BLE_ADV_DATA_MAX_LENTH             (31)
#define BLE_ADV_INTERVAL_100MS              MSEC_TO_UNITS(100, UNIT_0_625_MS)
#define BLE_ADV_INTERVAL_1000MS             MSEC_TO_UNITS(1000, UNIT_0_625_MS)
#define BLE_ADV_INTERVAL_10000MS            MSEC_TO_UNITS(10000, UNIT_0_625_MS)
#define BLE_ADV_NAME_STRING                ("HT32F675x5_BLE_LOW_POWER")  //max 26 bytes
#define BLE_DEVICE_MAC                     {0x55, 0x40, 0x4D, 0x03, 0x03, 0xBA}
#define BLE_RF_TX_POWER                    (TX_0_DBM)

//=====================================================================================================================
//Low Power Evaluation Define
//=====================================================================================================================
#define LOW_POWER_KEEP_SLEEP_NO_WAKEUP          (0)
#define LOW_POWER_KEEP_DEEP_SLEEP_NO_WAKEUP     (0)
#define LOW_POWER_HIBERNATION_NO_WAKEUP         (0)

#define LOW_POWER_DCDC_BLE_ADV_ITV_100MS        (0)
#define LOW_POWER_LDO_BLE_ADV_ITV_100MS         (0)
#define LOW_POWER_DCDC_BLE_ADV_ITV_1000MS       (0)
#define LOW_POWER_LDO_BLE_ADV_ITV_1000MS        (0)
#define LOW_POWER_DCDC_BLE_ADV_ITV_10000MS      (0)
#define LOW_POWER_LDO_BLE_ADV_ITV_10000MS       (1)
