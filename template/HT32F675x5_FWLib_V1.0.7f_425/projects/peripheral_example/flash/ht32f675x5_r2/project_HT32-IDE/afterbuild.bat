...
REM Two kind of way to create disassemble/text file, refer to "objcopy.txt" for more information

rem arm-none-eabi-objdump.exe -D "%1.elf"  > "%1.text"
arm-none-eabi-objdump.exe -S "%1.elf"  > "%1.text"

REM Copy hex file to hex document
copy /y %1.hex ..\..\hex\%~nx1.hex
