 ...
 */
extern EN_ERR_STA_T app_flash_read(uint32_t u32Addr, uint8_t *pu8Buf, uint32_t u32Len, EN_FLASH_BUS_MODE_T enMode);
 ...
 * @return status: @ref EN_ERR_STA_T.
 */
extern EN_ERR_STA_T app_flash_write(uint32_t u32Addr, uint8_t *pu8Buf, uint32_t u32Len, EN_FLASH_BUS_MODE_T enMode);
 ...
 * @return status: @ref EN_ERR_STA_T.
 */
extern EN_ERR_STA_T app_flash_erase(EN_SFLASH_ERASE_SIZE_T enSize, uint16_t u16Num);
