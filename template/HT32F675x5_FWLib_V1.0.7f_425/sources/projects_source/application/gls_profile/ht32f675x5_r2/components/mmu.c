...
#define MMU_GLS_DATABASE_MAX_SIZE                   (3 * 1024)
#define MMU_GLS_DB_RECORDS_NUMBER_MAX_SIZE          (2)
#define MMU_GLS_DB_RECORDS_ORDER_MAX_SIZE           (GLS_DB_RECORDS_MAX_NUM)
...
static const stMmuInfo_t stMmuInfo[EN_MMU_RESERVED] = {
    ...
    { EN_MMU_GLS_DATABASE           ,MMU_GLS_DATABASE_MAX_SIZE },
    { EN_MMU_GLS_DB_RECORDS_NUMBER  ,MMU_GLS_DB_RECORDS_NUMBER_MAX_SIZE},
    { EN_MMU_GLS_DB_RECORDS_ORDER   ,MMU_GLS_DB_RECORDS_ORDER_MAX_SIZE},
};
