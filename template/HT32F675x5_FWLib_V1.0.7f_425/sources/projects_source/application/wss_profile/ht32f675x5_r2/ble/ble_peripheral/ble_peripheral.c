...
void ble_peripheral_init(void)
{
    ...
    ble_gap_service_init((uint8_t *)BLE_ADV_NAME_STRING,strlen(BLE_ADV_NAME_STRING),GAP_APPEARE_GENERIC_WEIGHT_SCALE);
}
...
void start_pair_adv(void)
{
    ...
    uint8_t u8AdvData[] =
    {
        ...
        LO_UINT16(WS_SERV_UUID),
        HI_UINT16(WS_SERV_UUID),

        /* apperence */
        0x03,
        GAP_ADTYPE_APPEARANCE,
        LO_UINT16(GAP_APPEARE_GENERIC_WEIGHT_SCALE),
        HI_UINT16(GAP_APPEARE_GENERIC_WEIGHT_SCALE),
    };
