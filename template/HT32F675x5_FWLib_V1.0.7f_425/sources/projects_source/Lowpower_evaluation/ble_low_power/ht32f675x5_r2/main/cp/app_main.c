...
#if LOW_POWER_KEEP_SLEEP_NO_WAKEUP
    lpwr_ctrl_set_low_power_mode(LPWR_MODE_SLEEP);
    
#elif LOW_POWER_KEEP_DEEP_SLEEP_NO_WAKEUP
    lpwr_ctrl_set_low_power_mode(LPWR_MODE_DEEPSLEEP);
    
#elif LOW_POWER_HIBERNATION_NO_WAKEUP
    lpwr_ctrl_set_low_power_mode(LPWR_MODE_HIBERNATION);
#else
    ble_peripheral_init();
    ble_profile_init();
    system_lpwr_init(LPWR_MODE_SLEEP);
