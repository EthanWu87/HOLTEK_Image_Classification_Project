...
/** @addtogroup HT32F493x5_FLASH_save_data_when_power_off
  * @{
  */

uint32_t save_data[8] = {0x11111111,0x22222222,0x33333333,0x44444444,0x55555555,0x66666666,0x77777777,0x88888888};
...
/**
  * @brief  This function handles PVM interrupt request.
  * @param  None
  * @retval None
  */
