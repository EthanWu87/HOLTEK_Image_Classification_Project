...
#ifndef __HT32F493x5_H
#define __HT32F493x5_H
...
/**
  ...
  */
...
#if !defined (USE_HT32F49365_100LQFP)&& !defined (USE_HT32F49365_64LQFP) && !defined (USE_HT32F49365_48LQFP) && \
    !defined (USE_HT32F49365_48QFN)  && !defined (USE_HT32F49395_100LQFP)&& !defined (USE_HT32F49395_48LQFP) && \
    !defined (USE_HT32F49395_64LQFP) && !defined (USE_HT32F49395_48QFN)

    #error "Please select first the target device used in your application (in ht32f493x5.h file)"
#endif
    ...
    #define HT32F493x5
    #define LIBCFG_MAX_SPEED                (240000000)
    #define LIBCFG_FLASH_PAGESIZE           (2048)
    #define LIBCFG_RAM_SIZE                 (1024 * 96)
#endif

/**
  * define with package
  */
#if defined (USE_HT32F49365_100LQFP)|| defined (USE_HT32F49395_100LQFP)

    #define HT32F493x5_100
#endif

#if defined (USE_HT32F49365_64LQFP) || defined (USE_HT32F49395_64LQFP)

    #define HT32F493x5_64
#endif

#if defined (USE_HT32F49365_48LQFP) || defined (USE_HT32F49365_48QFN) || \
    defined (USE_HT32F49395_48LQFP) || defined (USE_HT32F49395_48QFN)

    #define HT32F493x5_48
#endif
...
/**
  ...
  */
#if defined (USE_HT32F49395_100LQFP) || defined (USE_HT32F49395_48LQFP) || \
    defined (USE_HT32F49395_64LQFP)  || defined (USE_HT32F49395_48QFN)

    #define LIBCFG_FLASH_SIZE               (LIBCFG_FLASH_PAGESIZE * 512)
    #define HT32F4939x
#endif

#if defined (USE_HT32F49365_100LQFP) || defined (USE_HT32F49365_64LQFP) || \
    defined (USE_HT32F49365_48LQFP)  || defined (USE_HT32F49365_48QFN)
...
/**
  * @brief ht32f493x5 standard peripheral library version number
  */
#define HT32_FWLIB_VER                  (0x01002002)
#define HT32_FWLIB_SVN                  (0x184)
...
#define __NVIC_PRIO_BITS          4        /*!< ht32 uses 4 bits for the priority levels     */
#define __Vendor_SysTickConfig    0        /*!< set to 1 if different systick config is used */
#define __FPU_PRESENT             1U       /*!< fpu present                                  */

/**
  * @brief ht32f493x5 interrupt number definition, according to the selected device
